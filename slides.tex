...
\begin{frame}[fragile]
	...
	\end{block}
	\pause
	\begin{block}{New note page theme}
		\begin{itemize}
			\item A \verb|big_preview| theme for beamer's notes pages:
		\end{itemize}
		\note{Notes appear below the slide preview}
			\fbox{\includegraphics[width=\linewidth]{big_notes}}
	\end{block}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{block}{Automatically compile and make svg files}
		\begin{itemize}
			...
			\item Builds .pdf\_tex for every \verb|\includesvg|'d svg figure
